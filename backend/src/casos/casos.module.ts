...
@Module({
  imports: [TypeOrmModule.forFeature([CasoEntity, EventoCasoEntity, CasoCanalEntity, MensajeChatInternoEntity]), CasoCanalModule, DespachoModule, CatalogosModule, UsuariosModule, TenantsModule, AuthModule, AuditoriaModule],
